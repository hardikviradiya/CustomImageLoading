...
import com.hardik.customimageloading.imageLoading.Utils.flushStackLocalLeaks
...
internal class HandlerDispatcher internal constructor(
  ...
  override fun shutdown() {
    super.shutdown()
    // Shutdown the thread pool only if it is the one created by ImageLoading.
    (service as? ImageLoaderExecutorService)?.shutdown()
